 ...
 */
public class Sol1123_LowestCommonAncestorOfDeepestLeaves {
    // recursion + recursion  O(n^2)
    ...
    // O(n)
    public TreeNode lcdDeepest(TreeNode root) {
    ...
    private Pair getLca(TreeNode root, int d) {
        ...
        Pair right = getLca(root.right, d + 1);  // post order traversal left right, then current
        if (left.d == right.d) {
